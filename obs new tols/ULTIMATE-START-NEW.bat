@echo off
title نظام Transfermarkt المتكامل - الاصدار الجديد

echo.
echo ========================================
echo    نظام Transfermarkt المتكامل
echo    Ultimate Transfermarkt System
echo    الاصدار الجديد - 2025
echo ========================================
echo.
...
echo.
echo للبدء السريع: اختر "تشغيل النظام الكامل"
echo سيتم فتح جميع الادوات تلقائيا في المتصفح
echo.
echo الادوات المتاحة:
echo + الاداة الرئيسية: استخراج بيانات حقيقية
echo + اداة العرض: عرض احترافي للبيانات
echo + مدير الشعارات: ادارة شاملة للشعارات
echo.
echo المشاكل الشائعة:
echo - Node.js غير مثبت: حمل من https://nodejs.org
echo - فشل التبعيات: تحقق من الانترنت
echo - المنفذ مستخدم: اغلق البرامج الاخرى
echo.
pause
goto MAIN_MENU
...
echo ========================================
echo.
echo هل انت متاكد من اغلاق النظام؟
set /p confirm="اكتب 'y' للتاكيد: "
